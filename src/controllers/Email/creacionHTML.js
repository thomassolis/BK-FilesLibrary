...
export const creacionNotificacionGerente = (ComentariOperador, NombreSolicitante, NombreArchivo, linkPagina) =>
{    
    const SaludoInicial = generarSaludoSegunHora();
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        ...
                        <tbody>
                            ...
                            <td align="justify" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:helvetica;font-size:20px;line-height:2;text-align:justify;color:black;">${NombreSolicitante} ha solicitado el Archivo: ${NombreArchivo} con el siguiente comentario:</div>
                            </td>
                            </tr>
                            <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            ...
                            <tr>
                            <td align="justify" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:helvetica;font-size:20px;line-height:2;text-align:justify;color:black;">Se Requiere que se apruebe la solicitud para ser enviada a un administrador que enviara el archivo; De no aceptar la soliciud no pasara a los administradores</div>
                            </td>
                            </tr>
                            <tr>
