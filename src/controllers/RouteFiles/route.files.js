...
import verificarToken from '../jwt/loginToken.js'
import crearUsuario from '../../querys/Login/crearUsuario.js'

// Establecer la conexión a la base de datos al iniciar el módulo
connectDB();

export const getManagerApproval = async (req, res) => {

    // console.log('datos desde el token: ',req.user);  
