import { listFilesInDrive, listNonFolderFilesInDrive, ObtenerArchivoDesdeDrive } from "../../Drive/driveService.js"
...
export const ctr_Archivos_por_rol = async (req, res) => {
    ...
    await listNonFolderFilesInDrive()
    res.json({ success: true, data: archivosEnDrive });
};
